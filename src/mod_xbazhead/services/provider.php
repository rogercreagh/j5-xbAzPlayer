...
return new class () implements ServiceProviderInterface {
    ...
    {
        $container->registerServiceProvider(new ModuleDispatcherFactoryServiceProvider('\\Crosborne\\Module\\XbAzHead'));
        $container->registerServiceProvider(new HelperFactoryServiceProvider('\\Crosborne\\Module\\XbAzHead\\Site\\Helper'));
